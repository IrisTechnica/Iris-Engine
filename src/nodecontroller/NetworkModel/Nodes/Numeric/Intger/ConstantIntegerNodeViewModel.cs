...
namespace NetworkModel {
    public class ConstantIntegerNodeViewModel : AbstractNodeViewModel {
        #region Internal Classes [None Internal constraints]

        public class InternalOutputs {
            private IntegerConnectorViewModel constantValue;

            public IntegerConnectorViewModel ConstantValue {
                get {
                    if ( constantValue == null ) constantValue = new IntegerConnectorViewModel("Value");
        ...
        public ConstantIntegerNodeViewModel( ) : base("Constant", typeof(int)) {
            Initialize();
        }
