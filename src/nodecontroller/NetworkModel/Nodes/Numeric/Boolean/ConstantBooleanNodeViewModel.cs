...
namespace NetworkModel {
    public class ConstantBooleanNodeViewModel : AbstractNodeViewModel {
        #region Internal Classes [None Internal constraints]

        public class InternalOutputs {
            private BooleanConnectorViewModel constantValue;

            public BooleanConnectorViewModel ConstantValue {
                get {
                    if ( constantValue == null ) constantValue = new BooleanConnectorViewModel("Value");
        ...
        public ConstantBooleanNodeViewModel( ) : base("Constant", typeof(Boolean)) {
            Initialize();
        }
