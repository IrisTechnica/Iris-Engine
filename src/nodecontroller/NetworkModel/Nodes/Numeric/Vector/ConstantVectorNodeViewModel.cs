...
namespace NetworkModel {
    public class ConstantVectorNodeViewModel : AbstractNodeViewModel {
        ...
        public class InternalOutputs {
            private VectorConnectorViewModel constantValue;

            public VectorConnectorViewModel ConstantValue {
                get {
                    if ( constantValue == null ) constantValue = new VectorConnectorViewModel("Value");
