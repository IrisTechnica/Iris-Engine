...
namespace NetworkModel {
    public class ConstantSoundNodeViewModel : AbstractNodeViewModel {
        #region Internal Classes [None Internal constraints]

        public class InternalOutputs {
            private SoundConnectorViewModel constantValue;

            public SoundConnectorViewModel ConstantValue {
                get {
                    if ( constantValue == null ) constantValue = new SoundConnectorViewModel("Value");
        ...
        public ConstantSoundNodeViewModel( ) : base("Constant", typeof(SoundData)) {
            Initialize();
        }
