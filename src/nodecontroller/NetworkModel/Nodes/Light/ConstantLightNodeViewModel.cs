...
namespace NetworkModel {
    public class ConstantLightNodeViewModel : AbstractNodeViewModel {
        #region Internal Classes [None Internal constraints]

        public class InternalOutputs {
            private LightConnectorViewModel constantValue;

            public LightConnectorViewModel ConstantValue {
                get {
                    if ( constantValue == null ) constantValue = new LightConnectorViewModel("Value");
        ...
        public ConstantLightNodeViewModel( ) : base("Constant", typeof(LightData)) {
            Initialize();
        }
